...
function cadastrar(req, res) {
    ...
    var email = req.body.emailServer;
    var senha = req.body.senhaServer;
    var arconteFav = req.body.arconteFavServer;
    ...
    } else if (arconteFav == undefined) {
        res.status(400).send("Escolha um arconte!");
    } else {
        
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrar(nickname, email, senha, arconteFav)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
